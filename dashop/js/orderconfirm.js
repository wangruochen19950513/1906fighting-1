function orders() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        console.log(results)
			if(results.code==50100){
			    alert("地址为空")
			    window.location.href = "addressAdmin.html"}
                        ...
                        orderConfirm.data = {
                            html_goods: function () {
                                ...
                                for (var i = 0; i < data_goods.length; i++) {
                                    ...
                                    HTML += '</div>'
                                    HTML += '<b><img src="../static/media/' + data_goods[i].default_image_url + '" style="width:100px"/></b>'
                                    HTML += '</li>'
                            ...
                            addads: function () {
                                ...
                                if (receiverName && receiverState && receiverCity && receiverDistrict && receiverAddress &&
                                    ...
                                    $.ajax({
                                        type: 'post',
                                        url: baseUrl + '/v1/user/'+username+'/address/'+id,
                                        datatype: JSON,
                                        beforeSend:function(request){
                                            request.setRequestHeader("authorization",token)
                                        },
